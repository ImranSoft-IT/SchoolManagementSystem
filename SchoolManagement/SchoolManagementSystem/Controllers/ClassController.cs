...
namespace SchoolManagementSystem.Controllers
{
    ...
    public class ClassController : ControllerBase
    {
        ...
        private readonly IClassRoutineRepository _ClassRoutineRepo;
        ...
        public ClassController( IShiftRepository shiftRepo,
                                ...
                                IClassRoutineRepository ClassRoutineRepo)
        {
            ...
            _ClassRoutineRepo = ClassRoutineRepo;
        }
        ...
        //Get: https://localhost:44388/Class/GetClassRoutine/1
        [HttpGet("{id}")]
        public async Task<ActionResult<ClassRoutine>> GetClassRoutine(int id)
        {
            var CRoutine = await _ClassRoutineRepo.GetClassRoutine(id);
            if (CRoutine == null)
            {
                return NotFound();
            }
        ...
        //Post : https://localhost:44388/Class/CreateClassRoutine
        [HttpPost]
        public async Task<ActionResult<ClassRoutine>> CreateClassRoutine(ClassRoutine classRoutine)
        {
            var cr = await _ClassRoutineRepo.CreateClassRoutine(classRoutine);
            if (cr == null)
            {
                return NotFound();
            }
        ...
        //Put : https://localhost:44388/Class/UpdateClassRoutine/3

        [HttpPut("{id}")]
        public async Task<ActionResult<ClassRoutine>> UpdateClassRoutine(int id, ClassRoutine classRoutine)
        {
            if (ModelState.IsValid)
            {
                var cr = await _ClassRoutineRepo.UpdateClassRoutine(id, classRoutine);
                if (cr != null)
                {
                    return Ok(cr);
                }
        ...
        //Delete : https://localhost:44388/Class/DeleteClassRoutine/3
        [HttpDelete]
        [Route("{id}")]
        public async Task<ActionResult<ClassRoutine>> DeleteClassRoutine(int id)
        {
            var cr = await _ClassRoutineRepo.DeleteClassRoutine(id);
            if (cr == null)
            {
                return NotFound();
            }
        ...
        //Get: https://localhost:44388/Class/GetClassRoutineForSection/1
        [HttpGet("{sectionId}")]
        public async Task<ActionResult<IEnumerable<ClassRoutine>>> GetClassRoutineForSection(int sectionId)
        {
            var CRoutine = await _ClassRoutineRepo.GetClassRoutineForSection(sectionId);
            if (CRoutine == null)
            {
                return NotFound();
            }
            return CRoutine.ToList();
        }
    }
}
